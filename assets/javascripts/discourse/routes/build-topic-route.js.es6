...
export default function(filter, extras) {
  ...
  return Discourse.Route.extend({
    ...
    beforeModel() {
      this.controllerFor('navigation-group').set('filterMode', filter);
    },
    ...
    setupController(controller, model) {
      ...
      this.controllerFor('navigation-group').set('group', group);
      this.controllerFor('navigation-group').set('canCreateTopic', model.get('can_create_topic'));
    },
    ...
    renderTemplate() {
      this.render('navigation-group', { outlet: 'navigation-bar' });
